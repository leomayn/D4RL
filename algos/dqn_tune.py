...
def make_train(config):
    ...
    def train(rng):
        ...
        def _update_step(runner_state, unused):
            ...
            def q_function_loss(q_params, obs, actions, rewards, dones, next_obs, discount, v_params, init_q_hs, init_v_hs):
                _, q_values = q_network.apply(q_params, init_q_hs, obs, actions, dones)
                
                _, next_v_values = v_network.apply(v_params, init_v_hs, next_obs, dones)
...
def tune(default_config):
    ...
    def wrapped_make_train():
        ...
        wandb.init(project=default_config['TUNE_PROJECT'])
    ...
    wandb.login()
    sweep_id = wandb.sweep(sweep_config, entity=default_config['ENTITY'],project=default_config['TUNE_PROJECT'])
